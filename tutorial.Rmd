...
Change `https://raw.githubusercontent.com/maczokni/rStudioTest/master/tutorial.html` to
`https://rawgit.com/maczokni/rStudioTest/master/tutorial.html` and put that in a web browser
